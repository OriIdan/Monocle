Monocle.Flippers.rtlSlider = function (reader) {

  var API = { constructor: Monocle.Flippers.rtlSlider }
...
// Constants
Monocle.Flippers.rtlSlider.DEFAULT_PANELS_CLASS = Monocle.Panels.TwoPane;
Monocle.Flippers.rtlSlider.FORWARDS = -1;
Monocle.Flippers.rtlSlider.BACKWARDS = 1;
Monocle.Flippers.rtlSlider.FOLLOW_DURATION = 100;
